...
const contentSections = [
    {
        id: 1,
        title: "Overview of Coins and XP",
        content:
    ...
    {
        id: 2,
        title: "What \"Collecting Coins\" Means",
        content:
            "You are granted a limited, non-exclusive, non-transferable license to access and use the Software/Platform solely for business purposes in object code form.",
        importantNote: "Coins and XP are loyalty tokens and do not represent real-world currency or have monetary value.",
    },
    {
        id: 3,
        title: "Non-Redeemable Nature of Rewards",
        content:
            "You are granted a limited, non-exclusive, non-transferable license to access and use the Software/Platform solely for business purposes in object code form.",
    },
    {
        id: 4,
        title: "How Rewards Are Issued",
        content:
            "You are granted a limited, non-exclusive, non-transferable license to access and use the Software/Platform solely for business purposes in object code form.",
    },
    {
...
export default function LoyaltyProgramTermsPage() {
                    ...
                    {contentSections.map((section) => (
                        ...
                        >
                            ...
                            {section.importantNote && (
                                <div className="relative w-full mt-2 p-3 bg-[#555555] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] rounded-lg">
                                    <p className="[font-family:'Poppins',Helvetica] text-white text-xs sm:text-[13px] tracking-[0] leading-5">
                                        <span className="font-bold">Important:</span> {section.importantNote}
                                    </p>
                                </div>
                            )}
                        </article>
